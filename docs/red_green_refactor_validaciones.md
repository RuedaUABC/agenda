...
- RF-006: validacion completa de tareas.
...
- RN-020, RN-024, RN-026, RN-027 y RN-028: reglas de clase relacionadas con
  materia, rango horario, normalizacion, longitudes y conflictos.
...
- `test/features/horario/clase_form_test.dart`
  ...
  - impide guardar una clase que se cruza con otra clase del mismo dia.
...
- `lib/features/horario/presentation/widgets/clase_form.dart`
  ...
  - bloquea el guardado cuando el horario se cruza con otra clase del mismo
    dia de la semana.
- `lib/features/horario/presentation/horario.dart`
  - pasa `controller.clases` al formulario para evaluar conflictos.

Politica definida para RF-019: ante conflicto de clase, el sistema impide el
